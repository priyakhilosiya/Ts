...
if($post_slug=='home'){
	wp_enqueue_style( 'home', get_stylesheet_directory_uri() . '/framework/css/home.css' );
}else{
	wp_enqueue_style( 'page-gainsight-app', get_stylesheet_directory_uri() . '/framework/css/page-gainsight-app.css' );
}
?>
